...
export default function Partenaires({
  ...
  return (
    <>
      <div className="block px-8 md:px-14 py-10 md:py-14 bg-[#f7f4f4] z-20">
        <div className="relative  w-full overflow-hidden">
          <h2 className="font-extrabold text-3xl text-slate-900 pb-10 text-center">
            Nos Partenaires
          </h2>
          <div className="flex h-full items-center justify-center space-x-7 md:space-x-8 [perspective:1000px] [transform-style:preserve-3d]">
            <motion.div
              drag="x"
              dragElastic={0}
              onDrag={handleDrag}
