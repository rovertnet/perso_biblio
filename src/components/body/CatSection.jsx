    ...
    <>
      <div className="block px-14 py-6 bg-[#f7f4f4]">
        ...
        <div className="grid grid-cols-4 gap-10 py-10">
          <div className="bg-white rounded-md px-3 py-3 shadow-md flex flex-col justify-center items-center">
            <img
              src={catimage}
              alt={catimage}
          ...
          <div className="bg-white rounded-md px-5 py-3 shadow-md flex flex-col justify-center items-center">
            <img
              src={catimage}
              alt={catimage}
              className="rounded-full h-16 w-16"
