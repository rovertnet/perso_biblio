  ...
  return (
    <>
      <div className="block h-full w-full py-32 px-32 hero object-cover md:object-cover">
        <h1 className="font-extrabold text-center md:text-5xl md:max-w-5xl max-w-5xl text-xl py-10  md:py-14 text-transparent bg-clip-text bg-gradient-to-r from-purple-700 from-10% via-blue-400 via-30% to-orange-500 to-90% ... uppercase">
